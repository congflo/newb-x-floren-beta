...
#define NL_SATURATION 1.            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
/* Terrain lighting */
#define NL_SUN_INTENSITY 5.   // 0.5 weak ~ 5.0 bright
...
#define NL_SHADOW_INTENSITY 1. // 0.0 no shadow ~ 1.0 strong shadow
//#define NL_BLINKING_TORCH     // [toggle] flickering light
//#define NL_CLOUD_SHADOW       // [toggle] cloud shadow (simple clouds only)

/* Sun/moon light color on terrain */
#define NL_MORNING_SUN_COL vec3(0.6,0.2,0.)
#define NL_NOON_SUN_COL    vec3(1.0,0.83,0.7)
...
#define NL_CLOUDY_FOG 0.         // [toggle] 0.0 subtle - 0.8 dense fog clouds
...
/* Ore glow intensity */
#define NL_GLOW_TEX 8.           // 0.4 weak ~ 8.0 bright
...
#define NL_WATER_BUMP 0.079        // 0.001 plain ~ 0.2 bumpy water
#define NL_WATER_WAVE_SPEED  0.8  // 0.2 calm ~ 2.0 turbulent
#define NL_WATER_TEX_OPACITY 0.79  // 0.0 plain water ~ 1.0 vanilla water texture
...
#define NL_WATER_TINT vec3(0.92,0.97,1.)
...
#define NL_UNDERWATER_STREAKS 2.            // [toggle] 0.8 subtle - 2.0 bright streaks from top
#define NL_UNDERWATER_TINT vec3(0.92,0.97,1.) // fog tint color when underwater
...
/* Galaxy */
#define NL_GALAXY_STARS 1.           // [toggle] 0.1 dim - 4.0 bright
#define NL_GALAXY_VIBRANCE 0.          // 0.0 white - 1.0 colorful
#define NL_GALAXY_SPEED 0.03            // 0.01 slow motion - 0.2 fast motion
#define NL_GALAXY_DAY_VISIBILITY 0.    // 0.0 invisible - 1.0 visible
...
#define NL_ENTITY_EDGE_HIGHLIGHT 1.8 // 0.0 no highlight ~ 1.6 bright highlight

/* Weather particles */
#define NL_WEATHER_SPECK 1.         // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 1.6    // 1.0 minimal ~ 8.0 violent

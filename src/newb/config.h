...
#define NL_MORNING_SUN_COL vec3(0.86, 0.5, 0.1)
#define NL_NOON_SUN_COL    vec3(1.0,1.0,1.0)
#define NL_NIGHT_SUN_COL   vec3(0.03,0.13,0.22)
...
#define NL_MIST_DENSITY 0.04      // 0.0 no mist ~ 1.0 misty
